...
public enum ErrorCode {
    ...
    ADDRESS_CANNOT_DELETE_ONLY_DEFAULT(HttpStatus.BAD_REQUEST),
    CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND),
    CATEGORY_NAME_DUPLICATE(HttpStatus.BAD_REQUEST),
    CATEGORY_HAS_CHILDREN(HttpStatus.BAD_REQUEST),
    CATEGORY_CANNOT_BE_OWN_PARENT(HttpStatus.BAD_REQUEST),
    BRAND_NOT_FOUND(HttpStatus.NOT_FOUND),
    BRAND_NAME_DUPLICATE(HttpStatus.BAD_REQUEST),
    BRAND_HAS_PRODUCTS(HttpStatus.BAD_REQUEST),
