    ...
    <Box>
        ...
        <CardContent sx={{ p: 2.5 }}>
          ...
          >
            ...
            <Stack direction="row" spacing={1}>
              ...
              <IconButton onClick={fetchUsers} disabled={isLoading} title="Làm mới dữ liệu">
                <RefreshIcon />
              </IconButton>
            </Stack>
          </Stack>
                      ...
                      <TableCell>
                        <Stack direction="row" spacing={0.5}>
                          {user.roles.map((role) => (
                            <Chip
                              key={role}
                              label={role === 'ADMIN' ? 'Quản trị viên' : 'Khách hàng'}
                              size="small"
      ...
      >
        <DialogTitle id="confirm-dialog-title">
          {targetUser?.status === 'LOCKED' ? 'Mở khoá tài khoản người dùng?' : 'Khoá tài khoản người dùng?'}
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          <Button
            ...
            autoFocus
          >
            {isUpdating ? 'Đang xử lý...' : targetUser?.status === 'LOCKED' ? 'Mở khoá' : 'Khoá tài khoản'}
          </Button>
        </DialogActions>
      </Dialog>
    </Box>
